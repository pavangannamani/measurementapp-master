    ...
    protected void onCreate(Bundle savedInstanceState) {
                    ...
                    if (btnLengthClicked) {
                        if (lastAnchorNode == null) {
                            ...
                            if (arrayList2.isEmpty()) {
                                ...
                                System.out.println(txtDistance +"line no 166");
                            } else {
                                arrayList1.clear();
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                /*int f1= Integer.parseInt(txtDistance.getText().toString());
                int f2=f1*100; */
                Intent in = new Intent(HelloSceneformActivity.this , MainActivity.class);
